<?php require 'partials/header.php' ?>
  ...
  <div class="row">
    ...
    <div class="column-3-4">
      <h2>FOCUS-GLUG</h2>
      <br>
      <p align="justify">FOCUS- Free software and Open SourCe Users-is started as a part of the FSMK by the students of Sri Venkateshwara College of Engineering. We too conduct free session through the academic year and propagate the message of 'Learning and Sharing' amongst us.</p>
    </div>
  </div>
  <br>
  <div class="row">
    <div class="column-3-4">
      <h2>Free software, Free as in Freedom</h2>
      <br>
